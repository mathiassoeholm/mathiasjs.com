...
Just fire up your serverless functions with `netlify dev` and create a POST request to localhost:8888/.netlify/signup with an email and password in the body.
