...
The diagram above  was greatly inspired by [this answer on StackOverflow](https://stackoverflow.com/questions/56147281/use-jwt-to-authenticate-separate-api-microservice)
...
Basic JavaScript
A little React, but not prerequisite to create the authentication service
