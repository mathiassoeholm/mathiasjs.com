...
Take a moment and carefully read each step, try and understand the purpose and why that step is necessary.
...
// 9. Return the user new user id and a Set-Cookie header with the JWT cookie
```
