...
date: 2020-02-08
slug: netlify-functions-authentication-service
---
...
If you open http://localhost:8888 you should see the application. Now try going to localhost:8888/.netlify/functions/hello. You should
...
Just fire up your serverless functions with `netlify dev` and create a POST request to

```
localhost:8888/.netlify/functions/signup
```

with an email and password in the body.
...
- Original diagram of overall architecture was inspired by [this Stackoverflow answer](https://stackoverflow.com/a/56149939/1157286)
