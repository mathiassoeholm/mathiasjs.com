...
<img src="global-execution-context.svg" alt="WWWWWWWWWWWWWW" />

A new execution context is created when we invoke `giveName`:

<img src="as-function-1.svg" alt="WWWWWWWWWWWWWW" />
...
<img src="as-function-2.svg" alt="WWWWWWWWWWWWWW" />
...
<img src="as-method-1.svg" alt="WWWWWWWWWWWWWW" />

We pop the `spiderman.getThis()` execution context when we return from the function.

<img src="as-method-2.svg" alt="WWWWWWWWWWWWWW" />
...
<img src="as-constructor-1.svg" alt="WWWWWWWWWWWWWW" />

We then assign a value to `this.job`, which sets the _job_ property on the new object:

<img src="as-constructor-2.svg" alt="WWWWWWWWWWWWWW" />
...
<img src="as-constructor-3.svg" alt="WWWWWWWWWWWWWW" />

### What if we forget new

It's easy to forget those three letters, n-e-w, and this frequently happens. Let's see what happens if we do forget it.
...
Let me end the post with a little challenge. Look at the following code:
